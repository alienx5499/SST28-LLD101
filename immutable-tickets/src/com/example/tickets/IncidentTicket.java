 ...
 *
 * <p>CURRENT STATE (BROKEN ON PURPOSE): - mutable fields - multiple constructors - public setters -
 * tags list can be modified from outside - validation is scattered elsewhere
 *
 * <p>DONE (student): refactor to immutable + Builder.
 */
public final class IncidentTicket {
  ...
  private IncidentTicket(Builder builder) {
    ...
    List<String> srcTags = builder.tags;
    if (srcTags == null || srcTags.isEmpty()) {
      this.tags = Collections.emptyList();
    } else {
      this.tags = Collections.unmodifiableList(new ArrayList<>(srcTags));
    }
