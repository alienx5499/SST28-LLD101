 ...
 *
 * <p>After refactor: - direct mutation should not compile (no setters) - external modifications to
 * tags should not affect the ticket - service "updates" should return a NEW ticket instance
 */
public class TryIt {
