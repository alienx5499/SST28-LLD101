 ...
 *
 * <p>CURRENT STATE (BROKEN ON PURPOSE): - Uses 'new MetricsRegistry()' instead of the singleton.
 *
 * <p>DONE (student): - Use MetricsRegistry.getInstance() and remove all direct instantiation.
 */
