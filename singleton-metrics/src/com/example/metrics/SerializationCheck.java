...
/**
 * Serializes and deserializes the registry. Starter will typically produce a NEW instance. After
 * fix, it must return the same singleton.
 */
public class SerializationCheck {
  ...
  private static MetricsRegistry deserialize(byte[] bytes)
