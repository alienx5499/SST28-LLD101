...
/**
 * CURRENT STATE (BROKEN ON PURPOSE): - Concrete class used directly by clients - Expensive load
 * happens every time display() is called - No access control
 *
 * <p>DONE (student): - Convert this into the RealSubject behind a Proxy, or replace with
 * RealReport.
 */
