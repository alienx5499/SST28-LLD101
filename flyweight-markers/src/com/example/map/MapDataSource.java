 ...
 *
 * <p>CURRENT STATE (BROKEN ON PURPOSE): - Creates new MarkerStyle per MapMarker via MapMarker
 * constructor.
 *
 * <p>DONE (student): - After introducing MarkerStyleFactory, refactor so identical styles are
 * shared. - Suggested approach: 1) Change MapMarker to accept MarkerStyle directly 2) Use
 * MarkerStyleFactory.get(shape,color,size,filled) here
 */
