...
/**
 * CURRENT STATE (BROKEN ON PURPOSE): A style object exists, but is mutable and is created per
 * marker, even when thousands of markers share the same config.
 *
 * <p>DONE (student): - Make this an immutable Flyweight (final fields, no setters).
 */
