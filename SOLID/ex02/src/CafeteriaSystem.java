...
public class CafeteriaSystem {
  ...
  public CafeteriaSystem(
      InvoiceStore store, OrderPricer pricer, BillCalculator billCalc, InvoiceBuilder builder) {
    this.store = store;
    this.pricer = pricer;
  ...
  public void checkout(String customerType, List<OrderLine> lines) {
    ...
    String raw =
        builder.build(invId, pr.lines, pr.subtotal, br.taxPct, br.tax, br.discount, br.total);
